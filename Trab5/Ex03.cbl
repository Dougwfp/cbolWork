...
PROCEDURE DIVISION.
    ...
    SUBTRACAO.
        COMPUTE wsvalor = wsvalor1 - wsvalor2
        DISPLAY 'A subtracao dos dois numeros eh igual a: ' wsvalor
        PERFORM INICIAL.

    MULTIPLICACAO.
        COMPUTE wsvalor = wsvalor1 * wsvalor2
        DISPLAY 'A multiplicacao dos dois numeros eh igual a: ' wsvalor
        PERFORM INICIAL.

    DIVISAO.
        COMPUTE wsvalor = wsvalor1 / wsvalor2
        DISPLAY 'A divisao dos dois numeros eh igual a: ' wsvalor
        PERFORM INICIAL.
